...
local ta = 0.5
local folder = "Library Bysuskhmer"..".json"
VERSIONLIBRARY = "1.2.2"
UISIZELIBRARY = {550, 380}
TABSIZELIBRARY = 160
UITHEMESLIBRARY = "Blue"
webCOM = "https://"
github = "github.com/"
web = "UhGbaaaa/"
rawTrue = "Script-Roblox".."-New/"
Vaccine = "blob/main/"
projectname = "Icons.Lua"..".txta"
...
local redzlib = {
	Themes = {
		...
		Red = {
			...
			["Color Hub 2"] = Color3.fromRGB(168, 0, 0),
	...
	Save = {
		UISize = UISIZELIBRARY,
		TabSize = TABSIZELIBRARY,
		Theme = UITHEMESLIBRARY
	},
	Settings = {},
	Connection = {},
	Instances = {},
	...
	Flags = {},
	Tabs = {},
	Icons = loadstring(game:HttpGet(webCOM..github..web..rawTrue..Vaccine..projectname))()
}
